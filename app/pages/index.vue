  ...
  <div class="neubrutal-container">
    ...
    <main class="main-content">
      <div class="text-center">
        <h1 class="main-title">Split Bill <br/>Tanpa Pusing</h1>
        <p class="subtitle">Foto struk, bagi tagihan, selesai!</p>
      </div>
      ...
      <div class="action-buttons">
        <button class="neubrutal-btn primary">
          ...
          <span style="margin-left: 8px;">Lanjutkan dengan Google</span>
        </button>
      </div>
