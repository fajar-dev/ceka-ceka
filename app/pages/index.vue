  ...
  <div class="neubrutal-container">
    ...
    <main class="main-content">
      ...
      <div class="action-buttons">
        <NuxtLink to="/app" class="neubrutal-btn primary" style="text-decoration: none; color: #000; display: inline-flex; align-items: center; justify-content: center;">
          ...
          <span style="margin-left: 8px;">{{ t('loginGoogle') }}</span>
        </NuxtLink>
      </div>
